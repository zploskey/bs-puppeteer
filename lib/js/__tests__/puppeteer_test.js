...
describe("Coverage", (function () {
        ...
        Jest.testPromise(/* None */0, "startJSCoverage, stopJSCoverage", (function () {
                return browser[0].newPage().then((function (page) {
                              var coverage = page.coverage;
                              return Coverage$BsPuppeteer.startJSCoverage(/* Some */[Coverage$BsPuppeteer.makeJSCoverageOptions(/* Some */[/* true */1], /* () */0)], coverage).then((function () {
                                                return page.goto("file://" + testPagePath, undefined);
                                              })).then((function () {
                                              return coverage.stopJSCoverage();
                                            })).then((function (report) {
                                            return Promise.resolve(Jest.Expect[/* toHaveLength */13](1, Jest.Expect[/* expect */0](report)));
                                          }));
                            }));
              }));
        Jest.testPromise(/* None */0, "startCSSCoverage, stopCSSCoverage", (function () {
                return browser[0].newPage().then((function (page) {
                              var coverage = page.coverage;
                              return Coverage$BsPuppeteer.startCSSCoverage(/* Some */[Coverage$BsPuppeteer.makeCSSCoverageOptions(/* Some */[/* true */1], /* () */0)], coverage).then((function () {
                                                return page.goto("file://" + testPagePath, undefined);
                                              })).then((function () {
