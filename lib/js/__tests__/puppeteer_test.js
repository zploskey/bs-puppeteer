...
describe("Target", (function () {
        var target = [/* () */0];
        Jest.beforeAllPromise(/* None */0, (function () {
                return Puppeteer.launch(noSandbox).then((function (prim) {
                                return prim.newPage();
                              })).then((function (page) {
        ...
        return Jest.testPromise(/* None */0, "createCDPSession", (function () {
...
describe("CDPSession", (function () {
        ...
        return Jest.testPromise(/* None */0, "send", (function () {
                      return browser[0].newPage().then((function (page) {
                                      return page.target().createCDPSession();
                                    })).then((function (session) {
