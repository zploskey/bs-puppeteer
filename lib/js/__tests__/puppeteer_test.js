...
describe("BrowserFetcher", (function () {
        return Jest.test("createBrowserFetcher", (function () {
                      return Jest.ExpectJs[/* toBeTruthy */28](Jest.Expect[/* expect */0](Puppeteer.createBrowserFetcher(Puppeteer$BsPuppeteer.makeBrowserFetcherOption(/* Some */["https://storage.googleapis.com"], /* Some */["<root>/.local-chromium"], /* Some */[/* Linux */137321428], /* () */0))));
                    }));
      }));
