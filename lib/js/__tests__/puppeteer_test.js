...
describe("BrowserFetcher", (function () {
        ...
        beforeAll((function () {
                browserFetcher[0] = Puppeteer.createBrowserFetcher(Puppeteer$BsPuppeteer.makeBrowserFetcherOption(/* Some */["https://storage.googleapis.com"], /* Some */["<root>/.local-chromium"], /* Some */[/* Linux */137321428], /* () */0));
                return /* () */0;
              }));
        Jest.test("createBrowserFetcher", (function () {
                return Jest.ExpectJs[/* toBeTruthy */28](Jest.Expect[/* expect */0](browserFetcher));
              }));
        return Jest.testPromise(/* None */0, "canDownload", (function () {
